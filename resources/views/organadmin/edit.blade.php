    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="/addorgan">add Organ</a></li>
          ...
          <div class="container">
            ...
            <form action="dataInsert" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <select name="gender" class="form-select"value="{{$organ->gender}}">
            ...
            <div class="mb-3">
                ...
                <select name="organ" class="form-select"value="{{$organ->organ}}">
            ...
            <div class="mb-3">
                ...
                <select name="state" class="form-select"value="{{$organ->state}}">
