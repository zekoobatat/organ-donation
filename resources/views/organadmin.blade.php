        ...
        <body>
            <div class="container">
                <table class="table table-primary table-striped">
                    <thead>
                        <tr style="font-family: 'Courier New', Courier, monospace; font-weight: bold; font-size: 20px;">
                            <th>ID</th>
                            <th>IC</th>
                            <th>Name</th>
                            <th>Age</th>
                    ...
                    @foreach ($organ as $cus )
                    <tr style="font-family: 'Arial', sans-serif; font-weight: normal; font-size: 16px;">
                    <td>{{$cus['id']}}</td>
                    <td>{{$cus['ic']}}</td>
                      <td>{{$cus['name']}}</td>
                      <td>{{$cus['age']}}</td>
                      ...
                      <td>{{$cus['status']}}</td>
                      <td>
                        <a href="{{ route('organadminedit', ['organ' => $cus->id]) }}" class="btn btn-primary" style="background-color: blue; color: white; padding: 5px 10px; border-radius: 5px; text-decoration: none;">Edit</a>
                    </td>
                    <td>
                        <form action="{{ route('deleteorgan', ['organ' => $cus->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" style="padding: 5px 10px; border-radius: 5px;">Delete</button>
                        </form>
                    </td>
